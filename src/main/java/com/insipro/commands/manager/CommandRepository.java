package com.insipro.commands.manager;
...
import com.insipro.utils.client.managers.api.command.exception.CommandUnhandledException;
import com.insipro.utils.client.managers.api.command.exception.ICommandException;
...
import com.insipro.utils.client.managers.api.command.registry.Registry;
import com.insipro.commands.argument.ArgConsumer;
import com.insipro.commands.argument.CommandArguments;
import com.insipro.commands.defaults.DefaultCommands;
    ...
    public Stream<String> tabComplete(String prefix) {
        ...
        if (args.isEmpty()) {
            return new TabCompleteHelper()
                    .addCommands(Essence.getInstance().getCommandRepository())
                    .filterPrefix(label)
                    .stream();
        } else {
