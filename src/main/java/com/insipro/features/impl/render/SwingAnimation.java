...
import com.insipro.events.item.HandAnimationEvent;
import com.insipro.events.item.SwingDurationEvent;
...
public class SwingAnimation extends Module {
    ...
    BooleanSetting onlyAura = new BooleanSetting("Только c Aura", "Показывает анимацию только при включенной киллауре")
            .setValue(false);

    public SwingAnimation() {
        super("SwingAnimation", "SwingAnimation", ModuleCategory.RENDER);
