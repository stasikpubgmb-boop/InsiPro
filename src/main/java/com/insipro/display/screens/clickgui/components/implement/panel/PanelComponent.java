...
import com.insipro.display.screens.clickgui.components.implement.customization.CustomizationComponent;
import com.insipro.display.screens.clickgui.components.implement.configs.ConfigsComponent;
...
public class PanelComponent extends AbstractComponent implements QuickImports {
    ...
    public boolean mouseScrolled(double mouseX, double mouseY, double amount) {
        if (Calculate.isHovered(mouseX, mouseY, x, y + 56, width, height - 52)) {
            ...
            int scrollSpeed = (int) com.insipro.features.impl.render.ClickGui.scrollSpeed.getValue();
