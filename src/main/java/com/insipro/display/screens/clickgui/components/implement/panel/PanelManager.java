package com.insipro.display.screens.clickgui.components.implement.panel;
...
import com.insipro.display.screens.clickgui.components.implement.other.SearchComponent;
...
public class PanelManager extends AbstractComponent {
    ...
    public PanelManager() {
        ...
        com.insipro.features.impl.render.ClickGui clickGui = com.insipro.features.impl.render.ClickGui.getInstance();
        if (clickGui != null) {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        Fonts.getSize(14, Fonts.Type.SuisseIntlMedium).drawRainbowString(context.getMatrices(), playerUUID, uidX, textY+6.5,
            com.insipro.utils.display.color.ColorAssist.getClientColor(), 
            com.insipro.utils.display.color.ColorAssist.getClientColor2());
        ...
        rectangle.render(ShapeProperties.create(context.getMatrices(), squareX, squareY, squareSize, squareSize)
                .round(4f)
                .color(com.insipro.utils.display.color.ColorAssist.getClientColor(), 
                       com.insipro.utils.display.color.ColorAssist.getClientColor2(),
                       com.insipro.utils.display.color.ColorAssist.getClientColor(), 
                       com.insipro.utils.display.color.ColorAssist.getClientColor2())
                .build());
        ...
        float zX = squareX + (squareSize - Fonts.getSize(16, com.insipro.utils.display.render.font.Fonts.Type.ESSENCE).getStringWidth("z")) / 2f;
        float zY = squareY + (squareSize - Fonts.getSize(16, com.insipro.utils.display.render.font.Fonts.Type.ESSENCE).getStringHeight("z")) / 2f;
    ...
    public boolean keyPressed(int keyCode, int scanCode, int modifiers) {
        ...
        if (keyCode == GLFW.GLFW_KEY_F && (modifiers & GLFW.GLFW_MOD_CONTROL) != 0) {
            com.insipro.utils.input.InputManager.activateInput(searchComponent);
            return true;
        }
