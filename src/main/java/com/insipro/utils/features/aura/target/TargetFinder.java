package com.insipro.utils.features.aura.target;
    ...
    public static class EntityFilter {
        ...
        private boolean isValidEntityType(LivingEntity entity) {
            return switch (entity) {
                case PlayerEntity player when (targetSettings.contains("Friends") || targetSettings.contains("Друзья") || !FriendUtils.isFriend(player)) 
                    -> targetSettings.contains("Players") || targetSettings.contains("Игроки");
                case AnimalEntity animal -> targetSettings.contains("Animals") || targetSettings.contains("Животные");
                case MobEntity mob -> targetSettings.contains("Mobs") || targetSettings.contains("Мобы");
                case ArmorStandEntity armorStand -> targetSettings.contains("Armor Stand") || targetSettings.contains("Подставка");
