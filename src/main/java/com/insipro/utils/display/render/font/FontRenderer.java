package com.insipro.utils.display.render.font;
...
import com.insipro.utils.display.render.font.entry.DrawEntry;
import com.insipro.utils.display.render.font.glyph.Glyph;
import com.insipro.utils.display.render.font.glyph.GlyphMap;
...
public class FontRenderer implements QuickImports {
    ...
    public static @NotNull Identifier randomIdentifier() {
        return Identifier.of("essence", "temp/" + StringHelper.randomString(32));
    }
