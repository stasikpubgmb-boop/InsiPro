package com.insipro.utils.client.managers.api.command.helpers;
    ...
    public void display(Function<E, Text> transform, String commandPrefix) {
        ...
        if (hasPrevPage) {
            prevPageComponent.setStyle(prevPageComponent.getStyle()
                    ...
                    .withHoverEvent(new HoverEvent(
                            ...
                            Text.literal("Нажми чтобы посмотреть предыдущую страницу")
                    )));
        } else {
        ...
        if (hasNextPage) {
            nextPageComponent.setStyle(nextPageComponent.getStyle()
                    ...
                    .withHoverEvent(new HoverEvent(
                            HoverEvent.Action.SHOW_TEXT,
                            Text.literal("Нажми чтобы посмотреть следующую страницу")
                    )));
        } else {
