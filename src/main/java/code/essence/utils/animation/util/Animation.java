package code.essence.utils.animation.util;

import code.essence.common.animation.inovated.EasingList;
...
public class Animation {
    ...
    private EasingList.Easing easing = Easings.LINEAR;
    ...
    public Animation run(double valueTo, double duration, EasingList.Easing easing) {
    ...
    public Animation run(double valueTo, double duration, EasingList.Easing easing, boolean safe) {
    ...
    public boolean update() {
        ...
        if (alive) {
            this.setValue(this.interpolate(this.getFromValue(), this.getToValue(), this.getEasing().ease((float) this.calculatePart())));
        } else {
            this.setStart(0L);
    ...
    public Animation setEasing(EasingList.Easing easing) {
        this.easing = easing;
        return this;
    }
