package code.essence.display.screens.clickgui.components.implement.window.implement.settings.group;
...
public class GroupWindow extends AbstractWindow {
    ...
    public GroupWindow(GroupSetting setting) {
        ...
        new SettingComponentAdder().addSettingComponent(setting.getSubSettings(), components, null);
    }
