...
import code.essence.display.screens.clickgui.components.implement.autobuy.util.krushprovider.KrushItem;
...
public class MiscProvider {
    public static List<AutoBuyableItem> getMisc() {
        ...
        misc.add(new KrushItem("Яйцо вихря", Items.PHANTOM_SPAWN_EGG, new ItemStack(Items.PHANTOM_SPAWN_EGG), Defaultpricec.getPrice("Яйцо вихря")));
