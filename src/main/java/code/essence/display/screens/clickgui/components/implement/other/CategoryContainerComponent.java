...
import code.essence.display.screens.clickgui.components.implement.category.CategoryComponent;
...
public class CategoryContainerComponent extends AbstractComponent {
    ...
    @Override
    public void tick() {
        if (TextComponent.typing || InputManager.hasActiveInputs()) InventoryFlowManager.unPressMoveKeys();
