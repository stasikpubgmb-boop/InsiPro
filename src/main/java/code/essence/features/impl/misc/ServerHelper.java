...
import code.essence.utils.display.color.GradientAssist;
        ...
        if (!potionQueue.isEmpty() && potionTimer.finished(150)) {
            ...
            if (info != null) {
                ...
                if (slot != null) {
                    ...
                    float cooldownProgress = code.essence.utils.interactions.item.ItemTask.getCooldownProgress(info.item);
