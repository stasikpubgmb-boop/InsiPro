...
import code.essence.features.impl.render.BlockESP;
...
public class BlockESPCommand extends Command {
    ...
    public void execute(String label, IArgConsumer args) throws CommandException {
        ...
        BlockESP blockESP = (BlockESP) Essence.getInstance().getModuleRepository().modules().stream()
    ...
    public void sendUsage() {
        ChatMessage.brandmessage("Пример использования команды .blockesp:");
