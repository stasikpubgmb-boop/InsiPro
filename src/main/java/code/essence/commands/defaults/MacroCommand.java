...
import code.essence.utils.client.managers.api.command.datatypes.MacroDataType;
import code.essence.utils.client.managers.api.command.datatypes.KeyDataType;
...
public class MacroCommand extends Command {
    ...
    public MacroCommand(Essence main) {
        super("macro", "macros");
    ...
    private void handleAddMacro(IArgConsumer args) throws CommandException {
        ...
        logDirect(Formatting.WHITE +
                ...
                + name + Formatting.WHITE
                + " с кнопкой " + Formatting.RED
                + StringHelper.getBindName(key).toLowerCase() + Formatting.WHITE
    ...
    private void handleRemoveMacro(IArgConsumer args) throws CommandException {
        ...
        if (macroRepository.hasMacro(name)) {
            ...
            logDirect(Formatting.WHITE + "Макрос " + Formatting.RED + name + Formatting.WHITE + " был успешно удален!");
        } else {
    ...
    private void handleClearMacros(IArgConsumer args) throws CommandException {
        ...
        logDirect("Все макросы были удалены.", Formatting.WHITE);
    }
